...
<!-- 1. 普通图，内容区宽度80%（最常用） -->
{{< figure src="/images/malware-analysis.jpg" caption="恶意代码动态分析流程" width="85%" >}}

<!-- 2. 超大架构图，突破内容区但控制在90%屏幕宽（技术文章神器） -->
{{< figure src="/images/system-topology.png" caption="系统整体架构（点击可放大）" class="big" width="92%" >}}

<!-- 3. 小插图，配合 left/right 浮动 -->
{{< figure src="/images/hpc-counters.png" caption="常用硬件性能计数器" class="right" width="42%" >}}