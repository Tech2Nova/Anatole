...
slug = "vercel-web-analytics-getting-started"
date = 2025-12-23
author = "Vercel"
description = "A comprehensive guide to help you get started with using Vercel Web Analytics on your project"

categories = ["Tutorial", "Vercel", "Web Analytics"]
...
Using the package manager of your choice, add the `@vercel/analytics` package to your project. This applies to: Next.js, Next.js App Router, SvelteKit, Remix, Create React App, Nuxt, Vue, Astro, and other frameworks.
...
**For Earlier Versions - Astro Config:**
```js
